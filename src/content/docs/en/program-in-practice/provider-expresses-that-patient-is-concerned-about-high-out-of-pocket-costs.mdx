---
title: Concerns About High Out Of Pocket Costs
description: As an PRODUCT X field representative, there will be times when questions about the PRODUCT X Support program will arise with customers.
i18nReady: true
type: base
---
...
<AccordionEntry 
	...
	question="Is the patient enrolled in PRODUCT X Support?"
	
>
    The patient may be eligible for Co-Pay Assistance through the PRODUCT X Support program if they are not already enrolled.
    ...
    {getRelatedResources([''], ['GROVERY Support Website']).map(relatedResource => (
